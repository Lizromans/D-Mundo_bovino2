...
urlpatterns = [
    ...
    path('marcar-vendido/<str:cod_ani>/', views.marcar_vendido, name='marcar_vendido'),
    ...
    path('api/animales-disponibles/', views.api_animales_disponibles, name='api_animales_disponibles'),
